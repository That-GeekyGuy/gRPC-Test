...
const file_serv_proto_rawDesc = "" +
	...
	"\aGreeter\x120\n" +
	"\bSayHello\x12\x12.serv.HelloRequest\x1a\x10.serv.HelloReplyB\tZ\a./;servb\x06proto3"

var (
	file_serv_proto_rawDescOnce sync.Once
	file_serv_proto_rawDescData []byte
)

func file_serv_proto_rawDescGZIP() []byte {
	file_serv_proto_rawDescOnce.Do(func() {
		file_serv_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_serv_proto_rawDesc), len(file_serv_proto_rawDesc)))
	})
...
var file_serv_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: serv.HelloRequest
	(*HelloReply)(nil),   // 1: serv.HelloReply
}
var file_serv_proto_depIdxs = []int32{
	0, // 0: serv.Greeter.SayHello:input_type -> serv.HelloRequest
	1, // 1: serv.Greeter.SayHello:output_type -> serv.HelloReply
...
func file_serv_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_serv_proto_rawDesc), len(file_serv_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
